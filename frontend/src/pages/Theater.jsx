    ...
    <div className="min-h-screen bg-[#121212] text-white p-6">
      ...
      <div className="max-w-6xl mx-auto  flex justify-between items-center mb-8 px-4 sm:px-0">
        ...
        <button
          ...
          className="bg-teal-600 hover:bg-teal-700 text-white font-semibold px-5 py-2 rounded-xl flex items-center gap-2 whitespace-nowrap shadow-md transition-colors duration-200"
        >
          <Plus size={18} />
          Add Theatre
        </button>
      ...
      <div className="max-w-5xl mx-auto space-y-4">
        {theatres.map((theatre) => (
          ...
          >
            <div>
            <h3 className="text-lg font-bold text-white">{`Theater ID : ${theatre.id}`}</h3>

              <h3 className="text-lg font-bold text-teal-400">{theatre.name}</h3>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center px-4">
          <div className="bg-gray-900 border border-teal-500 rounded-2xl shadow-xl w-full max-w-md p-6 relative">
            <button
